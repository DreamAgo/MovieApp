...
public class MovieSlide extends FrameLayout {
        private View menuView,mainView;
        private int menuWidth;
        private Scroller scroller;
        public MovieSlide(Context context) {
            super(context);
            init();
        }
        public MovieSlide(Context context, AttributeSet attrs) {
            super(context, attrs);
            init();
        }
        private void init(){
        ...
        private void closeMenu(){
            // startScroll(开始的x位置, startY, 水平偏移量+代表向左，-向右, dy, DEFAULT_DURATION);
